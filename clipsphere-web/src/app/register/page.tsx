...
export default function RegisterPage() {
  ...
  // Single navigation point — same pattern as login page
  useEffect(() => {
    ...
    <div className="flex min-h-[calc(100vh-160px)] items-center justify-center px-4 bg-gradient-to-br from-brand-500/5 via-transparent to-violet-500/5">
      <div className="glass glow-accent w-full max-w-md rounded-2xl p-8 animate-fade-in-up">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label htmlFor="username" className="mb-1 block text-sm font-medium text-text-muted">Username</label>
            <input
          ...
          <div>
            <label htmlFor="confirmPassword" className="mb-1 block text-sm font-medium text-text-muted">Confirm Password</label>
            <input
